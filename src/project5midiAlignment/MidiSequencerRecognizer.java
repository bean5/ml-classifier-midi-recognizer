...
public class MidiSequencerRecognizer {
	...
	private int minimumSnippetLength = 10;
	private int maximumSnippetLength = 40;
	private int snippetLengthStep = 10;
	private int minimumNoise = 0;
	private int maximumNoise = 60;
	private int noiseStep = 20;
	private String corporaPath;
	...
	public void run() 
	{
		...
		try {
			midiFiles = MidiFileFinder.findMidiFromDir(corporaPath);
	...
	{
		for (int testSequenceLength = minimumSnippetLength; testSequenceLength <= maximumSnippetLength; testSequenceLength += snippetLengthStep)
		{
			for (int simulatedNoiseRate = minimumNoise; simulatedNoiseRate <= maximumNoise; simulatedNoiseRate += noiseStep)
			{
	 ...
	 * Snippet Setters
	 */
	public void setMinimumSnippetLength(int i) {minimumSnippetLength = i;}
	public void setMaximumSnippetLength(int i) {maximumSnippetLength = i;}
	public void setStepSnippetLength(int i) {snippetLengthStep = i;}
	
	/*
	 * Noise Setters
	 */
	public void setNoiseMimimum(int i) {minimumNoise = i;}
	public void setNoiseMaximum(int i) {maximumNoise = i;}
	public void setNoiseStep(int i) {noiseStep = i;}
	
	// Corpora path setter
	public void setCorpora(String string) {corporaPath = string;}
}
